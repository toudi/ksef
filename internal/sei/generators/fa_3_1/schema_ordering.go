...
var FA_3_1ChildrenOrder = map[string]map[string]int{
	"Faktura":                                                               {"Naglowek": 0, "Podmiot1": 1, "Podmiot2": 2, "Podmiot3": 3, "PodmiotUpowazniony": 4, "Fa": 5, "Stopka": 6, "Zalacznik": 7},
	...
	"Faktura.Podmiot1.AdresKoresp":                                          {"KodKraju": 0, "AdresL1": 1, "AdresL2": 2, "GLN": 3},
	"Faktura.Podmiot1.DaneKontaktowe":                                       {"Email": 0, "Telefon": 1},
	"Faktura.Podmiot2":                                                      {"NrEORI": 0, "DaneIdentyfikacyjne": 1, "Adres": 2, "AdresKoresp": 3, "DaneKontaktowe": 4, "NrKlienta": 5, "IDNabywcy": 6, "JST": 7, "GV": 8},
	...
	"Faktura.Fa.Platnosc":                                                   {"Zaplacono": 0, "DataZaplaty": 1, "ZnacznikZaplatyCzesciowej": 2, "ZaplataCzesciowa": 3, "TerminPlatnosci": 4, "FormaPlatnosci": 5, "PlatnoscInna": 6, "OpisPlatnosci": 7, "RachunekBankowy": 8, "RachunekBankowyFaktora": 9, "Skonto": 10, "LinkDoPlatnosci": 11, "IPKSeF": 12},
	"Faktura.Fa.Platnosc.ZaplataCzesciowa":                                  {"KwotaZaplatyCzesciowej": 0, "DataZaplatyCzesciowej": 1, "FormaPlatnosci": 2, "PlatnoscInna": 3, "OpisPlatnosci": 4},
	"Faktura.Fa.Platnosc.TerminPlatnosci":                                   {"Termin": 0, "TerminOpis": 1},
	"Faktura.Fa.Platnosc.TerminPlatnosci.TerminOpis":                        {"Ilosc": 0, "Jednostka": 1, "ZdarzeniePoczatkowe": 2},
	...
	"Faktura.Zalacznik":                                                     {"BlokDanych": 0},
	"Faktura.Zalacznik.BlokDanych":                                          {"ZNaglowek": 0, "MetaDane": 1, "Tekst": 2, "Tabela": 3},
	"Faktura.Zalacznik.BlokDanych.MetaDane":                                 {"ZKlucz": 0, "ZWartosc": 1},
	"Faktura.Zalacznik.BlokDanych.Tekst":                                    {"Akapit": 0},
	"Faktura.Zalacznik.BlokDanych.Tabela":                                   {"TMetaDane": 0, "Opis": 1, "TNaglowek": 2, "Wiersz": 3, "Suma": 4},
	"Faktura.Zalacznik.BlokDanych.Tabela.TMetaDane":                         {"TKlucz": 0, "TWartosc": 1},
	"Faktura.Zalacznik.BlokDanych.Tabela.TNaglowek":                         {"Kol": 0},
	"Faktura.Zalacznik.BlokDanych.Tabela.TNaglowek.Kol":                     {"NKom": 0},
	"Faktura.Zalacznik.BlokDanych.Tabela.Wiersz":                            {"WKom": 0},
	"Faktura.Zalacznik.BlokDanych.Tabela.Suma":                              {"SKom": 0},
}

// ArrayElements marks nodes that can contain multiple elements.
var FA_3_1ArrayElements = map[string]bool{
	"Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu": true,
	"Faktura.Fa.DaneFaKorygowanej":                                   true,
	"Faktura.Fa.DodatkowyOpis":                                       true,
	"Faktura.Fa.FaWiersz":                                            true,
	"Faktura.Fa.FakturaZaliczkowa":                                   true,
	"Faktura.Fa.Platnosc.RachunekBankowy":                            true,
	"Faktura.Fa.Platnosc.RachunekBankowyFaktora":                     true,
	"Faktura.Fa.Platnosc.TerminPlatnosci":                            true,
	"Faktura.Fa.Platnosc.ZaplataCzesciowa":                           true,
	"Faktura.Fa.Podmiot2K":                                           true,
	"Faktura.Fa.Rozliczenie.Obciazenia":                              true,
	"Faktura.Fa.Rozliczenie.Odliczenia":                              true,
	"Faktura.Fa.WZ":                                                  true,
	"Faktura.Fa.WarunkiTransakcji.NrPartiiTowaru":                    true,
	"Faktura.Fa.WarunkiTransakcji.Transport":                         true,
	"Faktura.Fa.WarunkiTransakcji.Transport.WysylkaPrzez":            true,
	"Faktura.Fa.WarunkiTransakcji.Umowy":                             true,
	"Faktura.Fa.WarunkiTransakcji.Zamowienia":                        true,
	"Faktura.Fa.ZaliczkaCzesciowa":                                   true,
	"Faktura.Fa.Zamowienie.ZamowienieWiersz":                         true,
	"Faktura.Podmiot1.DaneKontaktowe":                                true,
	"Faktura.Podmiot2.DaneKontaktowe":                                true,
	"Faktura.Podmiot3":                                               true,
	"Faktura.Podmiot3.DaneKontaktowe":                                true,
	"Faktura.PodmiotUpowazniony.DaneKontaktowe":                      true,
	"Faktura.Stopka.Informacje":                                      true,
	"Faktura.Stopka.Rejestry":                                        true,
	"Faktura.Zalacznik.BlokDanych":                                   true,
	"Faktura.Zalacznik.BlokDanych.MetaDane":                          true,
	"Faktura.Zalacznik.BlokDanych.Tabela":                            true,
	"Faktura.Zalacznik.BlokDanych.Tabela.Suma.SKom":                  true,
	"Faktura.Zalacznik.BlokDanych.Tabela.TMetaDane":                  true,
	"Faktura.Zalacznik.BlokDanych.Tabela.TNaglowek.Kol":              true,
	"Faktura.Zalacznik.BlokDanych.Tabela.Wiersz":                     true,
	"Faktura.Zalacznik.BlokDanych.Tabela.Wiersz.WKom":                true,
	"Faktura.Zalacznik.BlokDanych.Tekst.Akapit":                      true,
}
